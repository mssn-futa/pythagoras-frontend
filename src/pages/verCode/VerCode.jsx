...
const VerifyEmail = () => {
  ...
  "
    >
      ...
      <div className="lg:hidden relative z-10 w-full min-h-screen flex flex-col items-center justify-between px-4 py-10">
        <div className="w-full max-w-md space-y-10 flex-1 flex flex-col justify-center">
          ...
          <p className="text-center text-sm text-[#2A742F]">
            Didn't receive code?
            <button
              onClick={handleResend}
